        ...
        <div className="info-holder">
            <div className="stickyContainer">
                <div className="pp-delivery-holder">
                    ...
                    <p className="pp-delivery-p">
                        — Доставка заказов осуществляется транспортной компанией
                        «Нова пошта». Стоимость
                        доставки
                        зависит от веса и количества товаров в заказе.
                        — Заказы на сумму более 1000 грн. доставляются
                        бесплатно.
                    </p>
                    <h1>Оплата</h1>
                    <p className="pp-delivery-p">
                        — Онлайн-оплата кредитной или дебетовой картой при
                        оформлении заказа на сайте.
                        — Оплата на расчетный счет в Приват банке.
                        — Оплата при получении (наложенный платеж). Комиссию
                        «Новой почты» (20 грн. + 2% от
                        суммы
                        перевода) оплачивает получатель.
                    </p>
                    <h1>Отправка</h1>
                    <p className="pp-delivery-p">
                        Отправка заказа день в день при условии оформления
                        заказа:
                        Пн.-Сб.: до 13.00
                        Вс.: выходной
                    </p>
            ...
            <div className="pp-body-content">
                ...
                <div className="pp-info-block">
                    ...
                    <ul>
                        {productInfoViewModel.info.descriptionsLi.map(li => <li
                            key={li.value}>{li.value}</li>)}
                    </ul>
                    ...
                    <div className="pp-available">
                        Доступность: <span
                        style={{color: "#739c0b"}}>В наличии</span>
                    </div>

                    <div className="pp-add-count">
                        <div className="pp-add-count-holder">
                            <button
                                disabled={productInfoViewModel.isDecrementButtonDisabled}
                                onClick={() => dispatcher(decrementPP())}
                                className="pp-increment-button">
                                -
                            </button>
                            <input disabled={true}
                                   value={productInfoViewModel.productAmountOrderInput}
                                   className="pp-count-input"/>
                            <button
                                disabled={productInfoViewModel.isIncrementButtonDisabled}
                                onClick={() => dispatcher(incrementPP())}
                                className="pp-increment-button">
                                +
                            </button>
                        </div>
                        <button type="submit" className="pp-add-cart-button">В
                            корзину
                        </button>
                    </div>
